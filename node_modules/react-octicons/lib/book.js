...
var CLASS_NAME = 'octicon octicon-book';

var BookIcon = function (_Component) {
  _inherits(BookIcon, _Component);

  function BookIcon() {
    _classCallCheck(this, BookIcon);

    return _possibleConstructorReturn(this, (BookIcon.__proto__ || Object.getPrototypeOf(BookIcon)).apply(this, arguments));
  }

  _createClass(BookIcon, [{
    key: 'render',
