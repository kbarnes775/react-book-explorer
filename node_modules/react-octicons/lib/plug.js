...
var CLASS_NAME = 'octicon octicon-plug';

var PlugIcon = function (_Component) {
  _inherits(PlugIcon, _Component);

  function PlugIcon() {
    _classCallCheck(this, PlugIcon);

    return _possibleConstructorReturn(this, (PlugIcon.__proto__ || Object.getPrototypeOf(PlugIcon)).apply(this, arguments));
  }

  _createClass(PlugIcon, [{
    key: 'render',
