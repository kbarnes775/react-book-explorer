...
var CLASS_NAME = 'octicon octicon-globe';

var GlobeIcon = function (_Component) {
  _inherits(GlobeIcon, _Component);

  function GlobeIcon() {
    _classCallCheck(this, GlobeIcon);

    return _possibleConstructorReturn(this, (GlobeIcon.__proto__ || Object.getPrototypeOf(GlobeIcon)).apply(this, arguments));
  }

  _createClass(GlobeIcon, [{
    key: 'render',
