...
var CLASS_NAME = 'octicon octicon-eye';

var EyeIcon = function (_Component) {
  _inherits(EyeIcon, _Component);

  function EyeIcon() {
    _classCallCheck(this, EyeIcon);

    return _possibleConstructorReturn(this, (EyeIcon.__proto__ || Object.getPrototypeOf(EyeIcon)).apply(this, arguments));
  }

  _createClass(EyeIcon, [{
    key: 'render',
