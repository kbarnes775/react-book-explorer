...
var CLASS_NAME = 'octicon octicon-device-mobile';

var DeviceMobileIcon = function (_Component) {
  _inherits(DeviceMobileIcon, _Component);

  function DeviceMobileIcon() {
    _classCallCheck(this, DeviceMobileIcon);

    return _possibleConstructorReturn(this, (DeviceMobileIcon.__proto__ || Object.getPrototypeOf(DeviceMobileIcon)).apply(this, arguments));
  }

  _createClass(DeviceMobileIcon, [{
    key: 'render',
