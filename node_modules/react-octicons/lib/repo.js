...
var CLASS_NAME = 'octicon octicon-repo';

var RepoIcon = function (_Component) {
  _inherits(RepoIcon, _Component);

  function RepoIcon() {
    _classCallCheck(this, RepoIcon);

    return _possibleConstructorReturn(this, (RepoIcon.__proto__ || Object.getPrototypeOf(RepoIcon)).apply(this, arguments));
  }

  _createClass(RepoIcon, [{
    key: 'render',
